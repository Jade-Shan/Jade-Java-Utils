...
public class Base64Util {
	 ...
	 * in Section 4 of RFC3548: <a href="http://www.faqs.org/rfcs/rfc3548.html"
	 * >http://www.faqs.org/rfcs/rfc3548.html</a>. It is important to note that data
	 * encoded this way is <em>not</em> officially valid Base64, or at the very
	 * least should not be called Base64 without also specifying that is was encoded
	 ...
	 * <a href="http://www.faqs.org/qa/rfcc-1940.html">http://www.faqs.org/qa/rfcc-
	 * 1940.html</a>.
	 */
	 ...
	 * </p> <p> This is the lowest level of the encoding methods with all possible
	 * parameters. </p>
	 *
	 ...
	 * 
	 * <pre>
	 *  GZIP: gzip-compresses object before encoding it. DONT_BREAK_LINES:
	 * don't break lines at 76 characters <i>Note: Technically, this makes your
	 ...
	 * 
	 * @param options
	 *            Specified options; alphabet type is pulled from this (standard,
	 *            url-safe, ordered)
	 * 
	 * @return String
	 * 
	...
	public static boolean encodeToFile(byte[] dataToEncode, String filename) {
		...
		try {
			bos = new Base64Util.OutputStream(new java.io.FileOutputStream(filename), Base64Util.ENCODE);
	...
	public static boolean decodeToFile(String dataToDecode, String filename) {
		...
		Base64Util.OutputStream bos = null;
		try {
			bos = new Base64Util.OutputStream(new java.io.FileOutputStream(filename), Base64Util.DECODE);
	...
	public static byte[] decodeFromFile(String filename) {
		...
		try {
			...
			// Open a stream
			bis = new Base64Util.InputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(file)),
					Base64Util.DECODE);
	...
	public static class InputStream extends java.io.FilterInputStream {
		...
		/**
		 * Constructs a {@link Base64Util.InputStream} in either ENCODE or DECODE mode.
		 * <p>
		 * Valid options:
		 * 
		 * <pre>
		 *  ENCODE or DECODE: Encode or Decode as data is read. DONT_BREAK_LINES:
		 * don't break lines at 76 characters (only meaningful when encoding) <i>Note:
		 * Technically, this makes your encoding non-compliant.</i>
		 * </pre>
		 * <p>
	...
	public static class OutputStream extends java.io.FilterOutputStream {
		...
		/**
		 * Constructs a {@link Base64Util.OutputStream} in either ENCODE or DECODE mode.
		 * <p>
		 * Valid options:
		 * 
		 * <pre>
