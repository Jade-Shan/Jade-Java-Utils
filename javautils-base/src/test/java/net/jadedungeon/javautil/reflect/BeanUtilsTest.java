 ...
 * 
 */
package net.jadedungeon.javautil.reflect;
...
import net.jadedungeon.javautil.base.BeanUtils;
...
public class BeanUtilsTest {
	...
	public void testGenClass() throws Exception {
		Object o = Class.forName("net.jadedungeon.javautil.reflect.Guest").newInstance();
